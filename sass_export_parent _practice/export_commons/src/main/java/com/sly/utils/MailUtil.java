...
public class MailUtil {
    ...
    public static void sendMsg(String to ,String subject ,String content) throws Exception{
        ...
        //4.设置消息的发送者
        Address fromAddr = new InternetAddress("13593066167@163.com"); //51dacc7ca566937e
        ...
        //9.设置火箭的发射目标
        transport.connect("smtp.163.com", "13593066167@163.com", "sly123"); //密码 授权密码!=登陆密码
        //10.发送
    ...
    public static void main(String[] args) throws Exception {
        MailUtil.sendMsg("1205901923@qq.com" , "我们去玩把", "你好");
    }
