...
<div id="frameContent" class="content-wrapper" style="margin-left:0px;">
    ...
    <section class="content">
        ...
        <div class="panel panel-default">
            ...
            <form id="editForm" action="${ctx}/cargo/factory/edit.do" method="post">
                ...
                <div class="row data-type" style="margin: 0px">
                    ...
                    <div class="col-md-4 data">
                        <input type="text" class="form-control" id="factoryName" placeholder="厂家简称" name="factoryName" value="${factory.factoryName}">
                    </div>

                    <div class="col-md-2 title">联系人(*)</div>
                    <div class="col-md-4 data">
                        <input type="text" class="form-control" id="contacts" placeholder="联系人" name="contacts" value="${factory.contacts}">
                    </div>
                    ...
                    <div class="col-md-4 data">
                        <input type="text" class="form-control" id="mobile" placeholder="手机号" name="mobile" value="${factory.mobile}">
                    </div>
        ...
        <script>
            function yanzheng() {
                let ctype = $("#ctypeInfo option:selected").text();
                let state = $("#stateInfo option:selected").text();
                let factoryName = $("#factoryName").val();
                let contacts = $.trim($("#contacts").val());
        ...
        <div class="box-tools text-center">
            <button type="button"  id="button1" onclick="yanzheng()" class="btn bg-maroon">保存</button>
