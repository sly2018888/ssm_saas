            ...
            <form id="editForm" action="${ctx}/cargo/goods/edit.do" method="post">
                ...
                <div class="row data-type" style="margin: 0px">
                    ...
                    <div class="col-md-4 data">
                        <input type="text" disabled="disabled" class="form-control" placeholder="货号" name="productNo" value="${goods.productNo}">
                    </div>

                    <div class="col-md-2 title">厂家简称</div>
                    <div class="col-md-4 data">
                        <select class="form-control" disabled="disabled" name="factoryId" id="factoryInfo" onchange="document.getElementById('factoryName').value=this.options[this.selectedIndex].text">
                            <option value="">${goods.factoryName}</option>
                    ...
                    <div class="col-md-4 data">
                        <input type="text" class="form-control" placeholder="单价" name="price" value="${goods.price}">
                    </div>
                    ...
                    <div class="col-md-4 data">
                        <input type="text" class="form-control" placeholder="数量" name="qty" value="${goods.qty}">
                    </div>

                    <div class="col-md-2 title">体积</div>
                    <div class="col-md-4 data">
                        <input type="text" class="form-control" placeholder="体积" name="cbm" value="${goods.cbm}">
                    </div>
