...
<div id="frameContent" class="content-wrapper" style="margin-left:0px;">
    ...
    <section class="content">
        <form id="addPackingForm" action="/cargo/packing/edit.do" method="post">
            <div class="panel panel-default">
                <div class="row data-type" style="margin: 0px">
                    <div class="col-md-2 title">卖方</div>
                    <div class="col-md-4 data">
                        <input type="text" class="form-control" placeholder="卖方" id="seller" name="seller" value="${packingListC.seller}"/>
                    </div>

                    <div class="col-md-2 title">买方</div>
                    <div class="col-md-4 data">
                        <input type="text" class="form-control" placeholder="买方" id="buyer" name="buyer" value="${packingListC.buyer}"/>
                    </div>

                    <div class="col-md-2 title">发票号</div>
                    <div class="col-md-4 data">
                        <input type="text" class="form-control" placeholder="发票号" id="invoiceNo" name="invoiceNo" value="${packingListC.invoiceNo}"/>
                    </div>
                    ...
                    <div class="col-md-4 data">
                        <input type="text" name="marks" id="marks" class="form-control" placeholder="唛头" value="${packingListC.marks}"/>
                    </div>

                    <div class="col-md-2 title">备注</div>
                    <div class="col-md-4 data">
                        <input type="text" name="descriptions" class="form-control" id="descriptions" placeholder="备注" value="${packingListC.descriptions}"/>
                    </div>
                            ...
                            <tbody>
                                <c:forEach items="${page.list}" var="o" varStatus="status">
                                    <tr class="odd" onmouseover="this.className='highlight'" onmouseout="this.className='odd'" >
                                        <td><input type="checkbox" name="id" id="id" value="${o.id}"/></td>
                                        <td>${o.id}</td>
                                        <td align="center">
                                                ${o.proNum}/${o.extNum}
                                        </td>
